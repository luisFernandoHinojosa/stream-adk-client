...
<main class="min-h-screen bg-gray-50 transition-colors duration-200 dark:bg-gray-900">
	<!-- Content -->
		...
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
			...
			<div class="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
				<div class="mb-4">
					...
					<p class="text-gray-600 dark:text-gray-400">Comparación mensual entre 2023 y 2024</p>
				</div>
				<LineChart
					data={lineData}
			...
			<div class="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
				<div class="mb-4">
					...
					<p class="text-gray-600 dark:text-gray-400">Comparación trimestral Q1 vs Q2 2024</p>
				</div>
				<BarChart
					data={barData}
		...
		<div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
			...
			<div class="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
				<div class="mb-4">
					...
					<p class="text-gray-600 dark:text-gray-400">Porcentaje de ingresos por categoría</p>
				</div>
				<PieChart
					data={[
