...
<svg
	...
	viewBox="0 0 24 24"
	fill="currentColor"
	class="icon icon-tabler icons-tabler-filled icon-tabler-layout-grid {className}"
	...
	/><path d="M19 13a2 2 0 0 1 2 2v4a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-4a2 2 0 0 1 2 -2z" /></svg
>
